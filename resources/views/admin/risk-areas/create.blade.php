...
@section('title', 'Add Risk Area - RailFlow')
                ...
                <div class="card shadow-lg border-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <h4 class="fw-bold mb-1">
                                    <i class="material-icons align-middle me-2 text-primary">add_location_alt</i>Add New
                                    Risk Area
                                </h4>
                                <p class="text-muted mb-0 text-sm">Define a new high-risk zone with precise coordinates</p>
                            </div>
                    ...
                    <div class="card-body pt-4">
                        <form action="{{ route('risk-areas.store') }}" method="POST">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="">
                                        ...
                                        <textarea name="description" class="form-control" rows="4"
                                            placeholder="Describe the risk factors and specific instructions for drivers...">{{ old('description') }}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="">
                                        ...
                                        <select name="status" class="form-control" required>
                                            <option value="Low" {{ old('status') == 'Low' ? 'selected' : '' }}>Low (Minor
                                                Risk)</option>
                                            <option value="Medium" {{ old('status', 'Medium') == 'Medium' ? 'selected' : '' }}>Medium (Caution Advised)</option>
                                            <option value="High" {{ old('status') == 'High' ? 'selected' : '' }}>High (Extreme
                                                Hazard)</option>
                                        </select>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <label class="fw-bold mb-2">Geographic Location Picker</label>
                                    <p class="text-muted text-xs mb-3">Click on the map or drag the marker to set the exact
                                        coordinates.</p>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-static">
                                        ...
                                        <input type="text" name="latitude" id="latitude" class="form-control" required
                                            readonly value="{{ old('latitude', '7.8731') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group input-group-static">
                                        ...
                                        <input type="text" name="longitude" id="longitude" class="form-control" required
                                            readonly value="{{ old('longitude', '80.7718') }}">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                ...
                                <button type="submit" class="btn btn-primary px-5">
                                    <i class="material-icons align-middle me-2">save</i>Save Risk Area
                                </button>
                            </div>
                        </form>
                    </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            const initialLat = {{ old('latitude', 7.8731) }};
            const initialLng = {{ old('longitude', 80.7718) }};
